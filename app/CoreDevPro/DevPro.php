...
namespace App\CoreDevPro;

use App\CoreDevPro\Helpers\QrCode\QrCodeGenerate;
use App\CoreDevPro\Helpers\Xml\XmlFormat;
use App\CoreDevPro\Helpers\Xml\XmlHash;
use App\CoreDevPro\Helpers\Storage\StorageDocument;
use App\CoreDevPro\WS\Client\WsClient;
use App\CoreDevPro\WS\Services\BillSender;
use App\CoreDevPro\WS\Services\ConsultCdrService;
use App\CoreDevPro\WS\Services\ExtService;
use App\CoreDevPro\WS\Services\SummarySender;
use App\CoreDevPro\WS\Services\SunatEndpoints;
use App\CoreDevPro\WS\Signed\XmlSigned;
use App\CoreDevPro\WS\Validator\XmlErrorCodeProvider;
...
//        dd($this->xmlSigned);
    ...
    {
        if ($this->isDemo) {
            $this->pathCertificate = app_path('CoreDevPro' . DIRECTORY_SEPARATOR .
