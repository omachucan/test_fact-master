...
{
    protected $with = ['user', 'state_type', 'document_type', 'currency_type', 'items'];
    ...
    public function pos()
    {
        return $this->hasOne(PosDocument::class, 'table_id2', 'id')->where('table_name2', 'sale_notes');
    }
    ...
    {
        return $this->hasMany(Payment::class, 'table_id', 'id')->where('table_name', 'sale_notes');
    }
