...
class DispatchController extends Controller
{
    ...
    public function resend($document_id)
    {
        ...
        try
        {
            ...
            $DevPro = DB::connection('tenant')->transaction(function () use ($document) {
                return new DevPro();
            });

            $DevPro->setDocument($document);
            $DevPro->setType('dispatch');
            ...
            if (!$has_cdr_file)
            {
                ...
                {
                    $DevPro->loadXmlSigned(); // se carga el xml firmado
