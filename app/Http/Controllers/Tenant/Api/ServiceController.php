...
use App\CoreDevPro\Services\Dni\Dni;
use App\CoreDevPro\Services\Extras\ExchangeRate;
use App\CoreDevPro\Services\Ruc\Sunat;
        ...
        if($date <= now()->format('Y-m-d')) {
            ...
            if ($ex_rate) {
                ...
                try{
                    ...
                    $ex_rate = \App\Models\Tenant\ExchangeRate::orderBy('date','desc')->first();
                    $sale = ($ex_rate)?$ex_rate->sale:null;
                }
