...
<table class="full-width">
    ...
    <tr>
        @if($establishment->address !== '-')
            <td class="text-center">{{$establishment->department->description }}, {{$establishment->province->description }}, {{$establishment->district->description }}, {{$establishment->address  }}</td>
        @endif
    </tr>
    <tr>
...
<table class="full-width">
    ...
    @if($note)
        <tr>
            <td class="desc">DOC. AFECTADO:</td>
            <td class="desc">{{$note->affected_document->getNumberFullAttribute()}}</td>
        </tr>
        <tr>
            <td class="desc">TIPO DE NOTA:</td>
            @if($note->note_credit_type_id)
                <td class="desc">{{$note->note_credit_type->description}}</td>
            @else
                <td class="desc">{{$note->note_debit_type->description}}</td>
            @endif                       
        </tr>
        <tr>
            <td class="desc">DESCRIPCIÓN:</td>
            <td class="desc">{{$note->note_description}}</td>
        </tr>
    @endif
</table>
@if ($document->guides)
