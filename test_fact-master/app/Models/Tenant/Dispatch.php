...
class Dispatch extends ModelTenant
{
    ...
    {
        $district =  District::find($this->origin->location_id);
        $province =  Province::find($district->province_id);
        $department =  Department::find($province->department_id);

        return  $department->description.' - '.$district->description.' - '.$district->description.' - '.$this->origin->address;
    }

    public function getAddressArrive()
    {
        $district =  District::find($this->delivery->location_id);
        $province =  Province::find($district->province_id);
        $department =  Department::find($province->department_id);

        return  $department->description.' - '.$district->description.' - '.$district->description.' - '.$this->delivery->address;
    }
}