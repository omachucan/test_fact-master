...
Vue.component('tenant-pos-shifts-index', require('./views/tenant/pos_shifts/index.vue'));

//pos stations
Vue.component('tenant-pos-stations-index', require('./views/tenant/pos_stations/index.vue'));
...
Vue.component('tenant-report-filter', require('./views/tenant/components/report_filter.vue'));
...
//configuration pos
Vue.component('tenant-pos-configurations-index', require('./views/tenant/pos_configurations/index.vue'));
