                        ...
                        <div class="box-body no-padding">
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    <table width="100%" class="table table-responsive-xl table-bordered table-hover">
                                        <thead class="">
                                            <tr >
                                                <th class="">#</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($reports as $key => $value)
                                                @if($value->state_type_id == 13)
                                                    <tr class="text-warning">
                                                @elseif(($value->document_type_id == '07' && $value->state_type_id == '01')  || ($value->document_type_id == '07' && $value->state_type_id == '02'))
                                                    <tr class="text-danger">
                                                @else
                                                    <tr>
                                                @endif 
                                                    @php
                                                        if(($value->document_type_id == '07' && $value->state_type_id == '01')  || ($value->document_type_id == '07' && $value->state_type_id == '02'))
                                                        {
                                                            $value->total_taxed = '-'.$value->total_taxed;
                                                            $value->total_igv = '-'.$value->total_igv;
                                                            $value->total = '-'.$value->total;
                                                        }
                                                        if($value->state_type_id == 13 )
                                                        {
                                                            $value->total_taxed = '0.00';
                                                            $value->total_igv = '0.00';
                                                            $value->total = '0.00';
                                                        }    
                                                    @endphp                                           
                                                    <td>{{$i}}</td>
