                ...
                <div class="card-body">
                    <div>
                        <form action="{{route('tenant.reports.sells.search')}}" class="el-form demo-form-inline el-form--inline" method="POST">
                            {{csrf_field()}}
                            <tenant-calendar :document_types="{{json_encode($document_types)}}" :establishments="{{json_encode($establishments)}}" data_d="{{$d ?? ''}}" data_a="{{$a ?? ''}}" establishment="{{$establishment_td ?? null}}" document_type="{{$document_type_td ?? null}} "></tenant-calendar>
                            ...
                            <div style="margin-bottom: 10px">
                                ...
                                @if(isset($records))
                                    <form action="{{route('tenant.report.sells.pdf')}}" class="d-inline" method="POST">
                                        ...
                                        <input type="hidden" value="{{$document_type_td}}" name="document_type_td">
