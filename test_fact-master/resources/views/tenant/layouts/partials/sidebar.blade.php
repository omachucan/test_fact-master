        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <li class="
                        {{ ($path[0] === 'pos-stations')?'nav-active':'' }}
                        ">
                        <a class="nav-link" href="{{route('tenant.pos_stations.index')}}">
                    ...
                    <li class="nav-parent {{  (($path[0] === 'reports') && in_array($path[1], ['', 'purchases', 'sells', 'customers', 'expenses', 'bill-open'])) ? 'nav-active nav-expanded' : ''}}">
                        <a class="nav-link" href="#">
                        ...
                        <ul class="nav nav-children">
                            ...
                            @endcan
                            @can('tenant.reports.expenses.index')
                                <li class="{{(($path[0] === 'reports') && ($path[1] === 'bill-open')) ? 'nav-active' : ''}}">
                                    <a class="nav-link" href="{{route('tenant.reports.bill_open.index')}}">
                                        Cuentas por Pagar
                                    </a>
                                </li>
                            @endcan
                    ...
                    @endcanany
                    @canany(['tenant.companies.index','tenant.catalogs.unidades','tenant.catalogs.categoria-productos','tenant.catalogs.marcas',
                    'tenant.catalogs.monedas','tenant.establishments.index','tenant.configuration.inventories',
                    'tenant.configuration.documents','tenant.configuration.advanced.index', 'tenant.configuration.inventories',
                    'tenant.configuration.shifts'])
                    <li class="nav-parent {{ in_array($path[0], ['companies', 'catalogs', 'advanced', 'establishments', 'inventories'])?'nav-active nav-expanded':'' }}">
                        ...
                        <ul class="nav nav-children" style="">
                            ...
                            <li class="{{($path[0] === 'pos' && $path[1] === 'configuration') ? 'nav-active': ''}}">
                                <a class="nav-link" href="{{route('tenant.pos.configuration.index')}}">POS</a>
                            </li>
                            @endcan --}}
