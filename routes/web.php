...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        /*fin cotizacion*/
        Route::get('update/files/{model}/{id}', 'Tenant\DownloadController@updateFiles');
...
//        Route::middleware(['auth', 'module'])->group(function() {
        Route::middleware(['auth'])->group(function () {
            ...
            Route::get('accounts/totals', 'Tenant\AccountController@totals');
...
//            Route::delete('suppliers/{supplier}', 'Tenant\SupplierController@destroy');
            ...
            Route::post('pos/init', 'Tenant\PosController@init');
            ...
            Route::get('pos/', 'Tenant\PosController@register')->name('tenant.pos.index')->middleware('hasAnyPermission:tenant.pos.store');
            Route::get('pos/sales', 'Tenant\PosController@sales')->name('tenant.pos.sales');
            Route::get('pos-shifts', 'Tenant\PosShiftController@index')->name('tenant.pos_shifts.index')->middleware('hasAnyPermission:tenant.pos.index');
            Route::get('pos-shifts/records', 'Tenant\PosShiftController@records');
            Route::get('pos-shifts/sells/{id}', 'Tenant\PosShiftController@sells');
            Route::get('pos-shifts/tables', 'Tenant\PosShiftController@tables');
            Route::get('pos-shifts/record/{id}', 'Tenant\PosShiftController@record');
            Route::get('pos-shifts/columns', 'Tenant\PosShiftController@columns');
            Route::post('pos-shifts', 'Tenant\PosShiftController@store');
            Route::post('pos-shifts/close', 'Tenant\PosShiftController@close');
            Route::post('pos-shifts/cash_store', 'Tenant\PosShiftController@cash_store');
            Route::get('pos-shifts/totals', 'Tenant\PosShiftController@totals');
            ...
            //Terminal
            Route::get('pos-stations', 'Tenant\PosStationController@index')->name('tenant.pos_stations.index')->middleware('can:tenant.pos-stations.index');
            Route::get('pos-stations/columns', 'Tenant\PosStationController@columns');
            Route::get('pos-stations/tables', 'Tenant\PosStationController@tables');
            Route::get('pos-stations/records', 'Tenant\PosStationController@records');
            Route::get('pos-stations/record/{id}', 'Tenant\PosStationController@record');
            Route::get('pos-stations/totals', 'Tenant\PosStationController@totals');
            Route::post('pos-stations', 'Tenant\PosStationController@store')->middleware('can:tenant.pos-stations.store');
            Route::delete('pos-stations/{id}', 'Tenant\PosStationController@destroy')->middleware('can:tenant.pos-stations.destroy');
            ...
            Route::post('sale-notes/cancel/{salenote}', 'Tenant\SaleNoteController@cancel');
            ...
            Route::delete('summaries/{summary}', 'Tenant\SummaryController@destroy')->middleware('can:tenant.summaries.destroy');
...
//            Route::get('voided/ticket/{voided_id}/{group_id}', 'Tenant\VoidedController@ticket');
            ...
            Route::get('reports/bill-open', 'Tenant\ReportBillOpenController@index')->name('tenant.reports.bill_open.index')->middleware('can:tenant.reports.index');
            Route::post('reports/bill-open/search', 'Tenant\ReportBillOpenController@search')->name('tenant.reports.bill_open.search');
            Route::post('reports/bill-open/pdf', 'Tenant\ReportBillOpenController@pdf')->name('tenant.reports.bill_open.report_pdf');
            Route::post('reports/bill-open/excel', 'Tenant\ReportBillOpenController@excel')->name('tenant.reports.bill_open.report_excel');
            ...
            //configuration pos
            Route::get('configuration/pos', 'Tenant\PosConfigurationController@index')->name('tenant.pos.configuration.index')->middleware('can:tenant.configuration.shifts');
            Route::get('configuration/pos/record', 'Tenant\PosConfigurationController@record')->middleware('can:tenant.configuration.shifts');
            Route::post('configuration/pos', 'Tenant\PosConfigurationController@store')->middleware('can:tenant.configuration.documents');
        });
    });
} else {
